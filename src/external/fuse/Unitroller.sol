...
abstract contract Unitroller {
    ...
    function _setMarketSupplyCaps(CERC20[] calldata cTokens, uint[] calldata newSupplyCaps) external virtual;
    function _setMarketBorrowCaps(CERC20[] calldata cTokens, uint[] calldata newBorrowCaps) external virtual;

    function _setPauseGuardian(address newPauseGuardian) public virtual returns (uint);
    function _setMintPaused(CERC20 cToken, bool state) public virtual returns (bool);
    function _setBorrowPaused(CERC20 cToken, bool borrowPaused) public virtual returns (bool);
    ...
    function _setCollateralFactor(CERC20 cToken, uint newCollateralFactorMantissa) public virtual returns (uint256);
    ...
    function _unsupportMarket(CERC20 cToken) external virtual returns (uint);
